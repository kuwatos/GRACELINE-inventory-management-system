...
export const ReportsManager = () => {
  const [reports, setReports] = useState<ReportRecord[]>([
    { id: "1", type: "Month-End Report", dateGenerated: "2026-03-31", generatedBy: "John Carlo" },
  ]);
  ...
  const filteredData = reports.filter((r) => 
    r.dateGenerated.includes(searchQuery) || r.generatedBy.toLowerCase().includes(searchQuery.toLowerCase())
  );
    ...
    <div className="space-y-6">
      ...
      <Card className="shadow-sm border-gray-200 p-8 rounded-2xl min-h-[400px]">
        ...
        <ReportsHistoryTable 
          ...
          onDelete={async (id: string) => setReports(reports.filter(r => r.id !== id))} 
        />
      </Card>
